// pages/main/main.js
var weatherData = require('./data.js'); //引用外部的js文件
Page({
   ...
   data: {
      ...
      //  }
      // city: weatherData.weather_list.city,
      // update_time: weatherData.weather_list.update_time,
      // weather_list: weatherData.weather_list.data,
      city: "",
      update_time: "",
      weather_list: "",
   ...
   onLoad: function(options) {
      var that=this;
      wx.request({
         url: 'https://www.tianqiapi.com/api/?version=v1&appsecret=5lwqMTmq&appid=81398518',
         header: {
